...
async function main() {
  ...
  console.log(
    `Users ready: ${admin.email}, ${manager.email}, ${customer.email}`,
  );
  ...
  console.log(
    `Warehouses ready: ${cairoWarehouse.code}, ${alexWarehouse.code}`,
  );
  ...
  const productsData = [
    ...
    },
    {
      sku: "MOU-001",
      name: "Wireless Mouse",
      description: "Ergonomic, USB-C rechargeable",
      price: 349.5,
    },
    {
      sku: "KEY-001",
  ...
  console.log(
    `Stock rows seeded for ${stockSeed.length} product/warehouse combinations`,
  );
